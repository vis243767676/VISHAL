...
import styles from "./FactorsImpact.module.css";

export type FactorsImpactType = {
  className?: string;
};

const FactorsImpact: FunctionComponent<FactorsImpactType> = ({
  className = "",
}) => {
  ...
  return (
    <div className={[styles.factorsImpact, className].join(" ")} data-acc-group>
